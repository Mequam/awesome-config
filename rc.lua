...
local vdesk = require "custom.vdesk"

local vdesk_wibox = require "custom.vdesk.vdesk_wibox"
...
beautiful.init("/home/j0hn/.config/awesome/themes/theme.lua")
...
mytextclocRight = wibox.widget.textclock()
    ...
    s.mytaglist = awful.widget.taglist {
        ...
        filter  = function (tag)
           ...
           if current_screen then
               return vdesk.is_topic_tag(tag.name,current_screen.topic) or not vdesk.is_topic_tag(tag.name,".*")
           end
        end,
...
globalkeys = gears.table.join(
    ...
    -- Layout manipulation
    awful.key({ "Mod1", "Mod4"   }, "Left", function () awful.client.swap.byidx(  1)    end,
    ...
    awful.key({ "Mod1","Control" }, "f", function () awful.spawn(webbrowser) end,
              {description = "open a terminal", group = "launcher"}),
